...
function DocumentConversionV1(options) {
  ...
  if (!this._options.version_date && !this._options.silent) {
    ...
    console.warn('[DocumentConversion] WARNING: No version_date specified. Using a (possibly old) default. ' + 'e.g. watson.document_conversion({ version_date: "2015-12-15" })');
  }
}
...
['getOutput', 'getOutputs', 'getJobLog', 'getJobs', 'getJob', 'createJob', 'getBatchDocument', 'getBatchDocuments', 'addDocumentToBatch', 'getDocument', 'getDocuments', 'uploadDocument', 'getBatchDocuments', 'updateBatch', 'getBatch', 'createBatch', 'getBatches'].forEach(function (name) {
