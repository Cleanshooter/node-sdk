...
NaturalLanguageUnderstandingV1.prototype.getCredentialsFromBluemix = function (name) {
  return extend({}, BaseService.prototype.getCredentialsFromBluemix.call(this, name), BaseService.prototype.getCredentialsFromBluemix.call(this, name.replace(/_/g, '-')));
};
